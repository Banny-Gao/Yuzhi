...
export class Service {
   ...
   * @throws ApiError
   */
  public static authControllerRegister(requestBody: CreateUserDto): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public static authControllerLogin(requestBody: LoginUserDto): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/auth/login',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static authControllerLoginWithSms(requestBody: SmsLoginDto): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/auth/login/sms',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static solarTermsControllerGetSolarTerms(year?: number): CancelablePromise<Array<SolarTerm>> {
    return __request(OpenAPI, {
      method: 'GET',
